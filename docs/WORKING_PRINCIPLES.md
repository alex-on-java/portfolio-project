...
Without explicit principles, "always time to do it properly" becomes subjective — each agent interprets "properly" differently, and the project drifts toward inconsistent decisions that compound silently.
